...
export const useTodoListQuery = (id: string) => {
  return useQuery({
...
export const useCreateTodoListMutation = () => {
  ...
  return useMutation({
    ...
    onMutate: async () => {
      ...
      if (previousLists) {
        queryClient.setQueryData(['todolists', 'infinite'], (old: any) => {
          if (!old) return old;
          return {
            ...old,
...
export const useUpdateTodoListMutation = () => {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: any }) => todoService.updateTodoList(id, data),
  ...
  return useMutation({
    ...
    onMutate: async (itemData) => {
      ...
      if (itemData.todolist_id) {
        queryClient.setQueryData(['todoitems', { todolist: itemData.todolist_id }], (old: any) => {
          if (!old) {
        ...
        queryClient.setQueryData(['todolists', 'infinite'], (old: any) => {
          ...
          return {
            ...
            pages: old.pages.map((page: any) => ({
              ...page,
              results: page.results.map((list: any) =>
...
export const useUpdateTodoItemMutation = () => {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: any }) => todoService.updateTodoItem(id, data),
    onSuccess: (data) => {
