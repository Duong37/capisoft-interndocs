      ...
      {!isLoading && !error && users && (
        <VStack gap={0} align="stretch">
          ...
          <Fragment key={u.id}>
            ...
            >
            <Stack w="full" direction={{ base: 'column', md: 'row' }} justify="space-between" align={{ base: 'stretch', md: 'center' }} gap={{ base: 12, md: 0 }}>
              ...
              <Stack direction={{ base: 'column', md: 'row' }} gap={{ base: 3, md: 16 }} align={{ base: 'stretch', md: 'center' }} w={{ base: 'full', md: 'auto' }}>
