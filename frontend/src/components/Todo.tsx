...
import TodoLists from './todo-components/TodoLists';
import TodoItemsAssignedToMe from './todo-components/TodoItemsAssignedToMe';

const Todo = () => {
  // Intersection observer refs
  const todoListsObserver = useRef<IntersectionObserver | null>(null);
  const assignedItemsObserver = useRef<IntersectionObserver | null>(null);
  ...
  const todoLists = useMemo(() => {
    ...
    const allLists: any[] = [];
    todoListsData.pages.forEach((page: any) => {
  ...
  const todoItemsAssignedToMe = useMemo(() => {
    ...
    // Extract results from paginated response
    const allItems: any[] = [];
    assignedItemsData.pages.forEach((page: any) => {
