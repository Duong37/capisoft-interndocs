...
The Modal comes with a scale transition by default but you can change it by passing a motionPreset prop, and setting its value to either slideInBottom, slideInRight, scale or none.
...
The filter property will have no effect on the background because the Modal is rendered within a Portal. This means you can only style components within the Modal by using this property.
